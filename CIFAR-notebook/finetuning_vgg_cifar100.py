...
#The tutorial published has been modified to perform CIFAR100 training on the AzureML portal
...
#Path to the root directory of the storage where the cifar100 data is kept
...
def train_model(model, dataloaders, criterion, optimizer, num_epochs=25, is_inception=False):
    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            run.log('Epoch accuracy', epoch_acc)
...
dataloaders_dict={}
trainset = datasets.CIFAR100(root=data_dir,train=True, download=False, transform=data_transforms['train'])
testset = datasets.CIFAR100(root=data_dir,train=False, download=False, transform=data_transforms['val'])

# Create training and validation dataloaders
dataloaders_dict['train'] = torch.utils.data.DataLoader(trainset,batch_size=batch_size, shuffle=True, num_workers=4)
dataloaders_dict['val'] = torch.utils.data.DataLoader(testset,batch_size=batch_size, shuffle=True, num_workers=4)
